...
class TFDataSet():
	...
	Input:
		...
		x_test_labels
	"""
	def __init__(self, train_vals, train_labels, test_vals, test_labels):
		self.train = self.getTrain(train_vals, train_labels)
		self.test = self.getTest(test_vals, test_labels)

	def getTrain(self, train_vals, train_labels):
		train = TrainSet(train_vals, train_labels)
		return train

	def getTest(self, test_vals, test_labels):
		test = TestSet(test_vals, test_labels)
		return test
...
class TestSet():
	def __init__(self, test_vals, test_labels):
...
myDS = TFDataSet(train_images, train_labels, test_images, test_labels)
